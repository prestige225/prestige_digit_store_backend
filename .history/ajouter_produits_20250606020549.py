...
produits = [
    {
        ...
        "stock": 15,
        "images": json.dumps(["sac1.jpg", "sac1.jpg", "sac1.jpg"])
    },
    {
        ...
        "categorie": "mode",
        "stock": 10,
        "images": json.dumps(["mode1.jpg", "mode1.jpg", "mode3.jpg"])
    },
    {
        "nom": "Store1 Scolaire",
        ...
        "categorie": "accessoire",
        "stock": 20,
        "images": json.dumps(["store1.jpg", "store1.jpg", "store1.jpg"])
    },
    {
        "nom": "EDUCA Pack 1",
        ...
        "categorie": "educatif",
        "stock": 30,
        "images": json.dumps(["EDUCA.jpg", "EDUCA.jpg", "EDUCA.jpg"])
    },
    {
        "nom": "EDUCA Pack 3",
    ...
    },
    {
        ...
        "stock": 5,
        "images": json.dumps(["ordi.jpg", "ordi.jpg", "ordi.jpg"])
    }
]
